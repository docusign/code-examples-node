...
function makeEnvelope(args) {
  ...
  let l1Name = 'Harmonica';
    let l1Price = 5;
    let l1Description = `$${l1Price} each`;
    let l2Name = 'Xylophone';
    let l2Price = 150;
    let l2Description = `$${l2Price} each`;
  ...
  let doc1 = new docusign.Document();
    let doc1b64 = Buffer.from(doc1HTML2).toString('base64');
  ...
  let signHere1 = docusign.SignHere.constructFromObject({
    ...
    let listItem0 = docusign.ListItem.constructFromObject({
      text: 'none',
      value: '0',
    });
    let listItem1 = docusign.ListItem.constructFromObject({
      text: '1',
      value: '1',
    });
    let listItem2 = docusign.ListItem.constructFromObject({
      text: '2',
      value: '2',
    });
    let listItem3 = docusign.ListItem.constructFromObject({
      text: '3',
      value: '3',
    });
    let listItem4 = docusign.ListItem.constructFromObject({
      text: '4',
      value: '4',
    });
    let listItem5 = docusign.ListItem.constructFromObject({
      text: '5',
      value: '5',
    });
    let listItem6 = docusign.ListItem.constructFromObject({
      text: '6',
      value: '6',
    });
    let listItem7 = docusign.ListItem.constructFromObject({
      text: '7',
      value: '7',
    });
    let listItem8 = docusign.ListItem.constructFromObject({
      text: '8',
      value: '8',
    });
    let listItem9 = docusign.ListItem.constructFromObject({
      text: '9',
      value: '9',
    });
    let listItem10 = docusign.ListItem.constructFromObject({
      text: '10',
      value: '10',
    });
    let listl1q = docusign.List.constructFromObject({
      font: 'helvetica',
      fontSize: 'size11',
      anchorString: '/l1q/',
      anchorYOffset: '-10',
    ...
    let listl2q = docusign.List.constructFromObject({
      font: 'helvetica',
      fontSize: 'size11',
      anchorString: '/l2q/',
      anchorYOffset: '-10',
    ...
    let formulal1e = docusign.FormulaTab.constructFromObject({
      font: 'helvetica',
      fontSize: 'size11',
      anchorString: '/l1e/',
      anchorYOffset: '-8',
    ...
    let formulal2e = docusign.FormulaTab.constructFromObject({
      font: 'helvetica',
      fontSize: 'size11',
      anchorString: '/l2e/',
      anchorYOffset: '-8',
    ...
    let formulal3t = docusign.FormulaTab.constructFromObject({
      font: 'helvetica',
      bold: 'true',
      fontSize: 'size12',
      anchorString: '/l3t/',
    ...
    // Payment line items
    let paymentLineIteml1 = docusign.PaymentLineItem.constructFromObject({
      name: l1Name,
      description: l1Description,
      amountReference: 'l1e',
    });
    let paymentLineIteml2 = docusign.PaymentLineItem.constructFromObject({
      name: l2Name,
      description: l2Description,
      amountReference: 'l2e',
    });
    let paymentDetails = docusign.PaymentDetails.constructFromObject({
    ...
    let formulaPayment = docusign.FormulaTab.constructFromObject({
      tabLabel: 'payment',
