...
eg005GetRoomsWithFilters.createController = async (req, res) => {
    ...
    let body = req.body
        ...
        , roomsArgs = {
            fieldDataChangedStartDate: moment(),
            fieldDataChangedEndDate: moment().subtract(30, 'days').format()
        }
        , args = {
    ...
    if (results) {
        res.render('pages/example_done', {
            title: "The rooms with filters was loaded",
            h1: "The rooms with filters was loaded",
...
eg005GetRoomsWithFilters.worker = async (args) => {
    ...
    console.log(`Get Rooms with filters ${results}`);
