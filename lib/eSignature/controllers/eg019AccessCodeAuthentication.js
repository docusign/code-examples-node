...
const { accessCodeAuthentication } = require('../examples/accessCodeAuthentication');
const validator = require('validator');
const dsConfig = require('../../../config/index.js').config;

const eg019AccessCodeAuthentication = exports;
const eg = 'eg019'; // This example reference.
...
eg019AccessCodeAuthentication.createController = async (req, res) => {
    ...
    try {
        ...
        results = await accessCodeAuthentication(args);
    }
    catch (error) {
