...
function makeEnvelope(args) {
  ...
  let docBytes = fs.readFileSync(args.docFile);
    ...
    let textLegal = docusign.Text.constructFromObject({
      anchorString: '/legal/',
      anchorUnits: 'pixels',
      anchorYOffset: '-9',
      anchorXOffset: '5',
    ...
    let textFamiliar = docusign.Text.constructFromObject({
    ...
    let salaryReadable = usFormat.format(salary);
    let textSalary = docusign.Text.constructFromObject({
      anchorString: '/salary/',
      anchorUnits: 'pixels',
      anchorYOffset: '-9',
      anchorXOffset: '5',
