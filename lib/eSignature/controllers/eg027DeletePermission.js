...
const deletePermission = require('../examples/deletePermission');
...
eg027DeletePermission.createController = async (req, res) => {
    ...
    try {
        ...
        await deletePermission.deletePermission(args);
...
eg027DeletePermission.getController = async (req, res) => {
    ...
    if (tokenOK) {
        ...
        const permissionProfiles = await deletePermission.getPermissions(args);
