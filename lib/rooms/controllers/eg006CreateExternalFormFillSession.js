...
const createExternalFormFillSession = require('../examples/createExternalFormFillSession');
const validator = require('validator');
const dsConfig = require('../../../config/index.js').config;

const eg006CreateExternalFormFillSession = exports;
const eg = 'eg006rooms'; // This example reference.
...
eg006CreateExternalFormFillSession.createController = async (req, res) => {
    ...
    const results = await createExternalFormFillSession.createSession(args);
...
eg006CreateExternalFormFillSession.getController = async (req, res) => {
    ...
    if (tokenOK) {
        ...
        const userRooms = await createExternalFormFillSession.getRooms(args);
