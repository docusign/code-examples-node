...
let DSAuthCodeGrant = function _DSAuthCodeGrant(req) {
  ...
  this._refreshToken = req.user && req.user.refreshToken;   // The refresh token is not used in this example
  ...
  this._basePath = req.session && req.session.basePath; // eg https://na2.docusign.net/restapi
 ...
 * @function
 * @returns boolean mustAuthenticate
 */
DSAuthCodeGrant.prototype.checkToken = function _checkToken(req) {
  ...
  if (this._debug) {
    ...
    return Promise.resolve(needToken)
  }
 ...
 * @param {boolean} debug
 */
DSAuthCodeGrant.prototype.setDebug = function(debug){this._debug = debug};
/**
 * Getter for <tt>debug</tt>
 * @function
 * @returns {boolean} debug
 */
DSAuthCodeGrant.prototype.getDebug = function(){return this._debug};
/**
 ...
 */
DSAuthCodeGrant.prototype.test_set_jwt_life_sec =
   ...
   */
DSAuthCodeGrant.prototype.test_get_token = function(){return this._accessToken};
/**
 * For testing: Getter for the object's token_expiration
 * @function
 * @returns {string} token_expiration
 */
DSAuthCodeGrant.prototype.test_get_token_expiration = function(){return this._tokenExpiration};
/**
 * For testing: Clears the account user information:
 * the <tt>user</tt>, <tt>accountId</tt>, <tt>accountName</tt>, <tt>baseUri</tt>
 * @function
 */
DSAuthCodeGrant.prototype.test_clear_account_user = function(){
  this._user = {};
