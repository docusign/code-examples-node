...
const createRoomFromTemplate = exports

/**
 * This function does creation of the room with data
 * @param {object} args
 */
createRoomFromTemplate.createRoom = async (args) => {
 ...
 */
createRoomFromTemplate.getTemplates = async (args) => {
    let dsApiClient = new docusignRooms.ApiClient();
    dsApiClient.setBasePath(args.basePath);
    dsApiClient.addDefaultHeader('Authorization', 'Bearer ' + args.accessToken);
    ...
    userRoomsTemplates = await roomTemplatesApi.getRoomTemplates(args.accountId, null, null);
