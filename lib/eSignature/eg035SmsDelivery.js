...
const eg035SmsDelivery = exports
    , eg = 'eg035' // This example reference.
...
eg035SmsDelivery.createController = async (req, res) => {
    ...
    try {
        results = await eg035SmsDelivery.worker (args)
    }
    catch (error) {
 ...
 */
// ***DS.snippet.0.start
eg035SmsDelivery.worker = async (args) => {
...
function makeEnvelope(args){
    ...
    let smsNotification = new docusign.RecipientAdditionalNotification();
    smsNotification.phoneNumber = signerPhoneNumber;
    smsNotification.secondaryDeliveryMethod = 'SMS';
    ...
    let signer1 = docusign.Signer.constructFromObject({
        ...
        recipientId: '1',
        routingOrder: '1'});
    signer1.additionalNotifications = [smsNotification];
