...
5. Copy and paste the new RSA private key into an enviorntmental variable or into **config/appsettings.json** file.  REMOVE the automatic spaces that may be generated by the IDE as this will cause JWT to fail.
