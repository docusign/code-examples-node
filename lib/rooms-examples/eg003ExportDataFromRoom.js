...
eg003ExportDataFromRoom.createController = async (req, res) => {
    ...
    if (results) {
        res.render('pages/example_done', {
            ...
            message: `Results from the Rooms::GetRoomFieldData method RoomId: ${results.roomId} :`,
...
eg003ExportDataFromRoom.worker = async (args) => {
    ...
    results = roomsApi.GetRoomFieldData(accountId, args.roomsArgs.roomId);
                
    console.log(`Rooms Data retrieved: ${results}`);
...
eg003ExportDataFromRoom.getController = async (req, res) => {
    ...
    if (tokenOK) {
        ...
        rooms = await roomsApi.getRooms(req.session.accountId, {count: 5}/*optional*/, null);
        console.log(rooms)
