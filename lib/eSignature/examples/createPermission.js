...
const createPermission = exports


createPermission.createPermission = async (args) => {
  ...
  let results = await accountsApi.createPermissionProfile(args.accountId, requestBody)
