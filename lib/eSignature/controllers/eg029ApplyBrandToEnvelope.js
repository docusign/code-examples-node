...
const applyBrandToEnvelope = require('../examples/applyBrandToEnvelope');
const validator = require('validator');
const dsConfig = require('../../../config/index.js').config;

const eg029ApplyBrandToEnvelope = exports;
const eg = 'eg029'; // This example reference
...
eg029ApplyBrandToEnvelope.getController = async (req, res) => {
    ...
    if (tokenOK) {
        ...
        const brandsResponse = await applyBrandToEnvelope.getBrands(args);
